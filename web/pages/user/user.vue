		...
		>
			...
			<view style="background: #fff;margin-top: 10px;">
				...
				<view class="user-menus">
					...
					<view class="user-item" @click="navTo('/pages/agent/index')"  hover-class="common-hover" :hover-stay-time="50" v-if="userInfo.is_agent == 1">
						<uni-icons type="paperplane-filled" size="30" color="$icon-color" class="icon-class"></uni-icons>
						<text>我的推广</text>
					</view>
				</view>
			</view>
