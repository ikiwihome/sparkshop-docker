<template>
	<view style="background: #fff;">
		...
		<view class="goods-section" v-if="errorFlag === false">
			...
			<view v-if="goodsInfo.user_comments == 2 && goodsInfo.comment">
				<view class="uni-padding-wrap">
					<view class="appraise-type">
						评价类型
				...
				<view class="comment-img">
					<view style="margin-left: 20px;" v-for="item,index in appraisePic" :key="index" @click="showBig(item)">
						<img :src="item" class="appeaise-pic"/>
					</view>
				</view>
			</view>
			<view style="margin-top: 50px;text-align: center;color:#909399;margin-bottom: 50px;" v-else>评论被删除</view>
		</view>
	</view>
</template>
