...
class CouponService
{
     ...
     * @return array
     */
    public function getCouponGoodsList(int $couponId): array
    {
        $couponGoodsModel = new CouponGoods();
     ...
     */
    public function getCanReceiveList(array $param, int $type = 1): array
    {
        $couponModel = new Coupon();
        // 一键过期优惠券
        ...
        if (empty($param['goods_id'])) {
            $couponGoodsModel = new CouponGoods();
            $couponGoodsList = $couponGoodsModel->getAllList([], 'coupon_id')['data'];
        } else {
            $couponGoodsModel = new CouponGoods();
     ...
     * @throws ModelNotFoundException
     */
    public function getMyCouponList(array $param, int $type = 1): array
    {
        $couponModel = new Coupon();
        // 一键过期优惠券
        $couponModel->updateByWhere([
