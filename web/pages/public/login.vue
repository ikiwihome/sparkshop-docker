		...
		<view class="wrapper">
			...
			<view class="uni-padding-wrap uni-common-mt">
				 <view class="uni-flex uni-row">
					<view class="flex-item forget-section" @click="smsLogin" v-show="login_type == 1 || login_type == 3">短信登陆</view>
					<view class="flex-item forget-section" @click="accountLogin" v-show="login_type == 2 || login_type == 3">账号密码登录</view>
				</view>
			</view>
		</view>
		...
		methods: {
			...
			async goLogin() {
				...
				if (this.login_type == 2) {
					...
					if (res.code == 0) {
						this.btnTxt = '登陆'
						this.$tool.msg(res.msg, 1500, false, 'success')
						uni.removeStorageSync('send-msg-time')
						this.logining = false;
						this.login_type = 1
					} else {
