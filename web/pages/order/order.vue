<template>
	<view class="content">
		...
		<swiper :current="tabCurrentIndex" @change="changeStatusTab" class="swiper-box" duration="300">
	...
	export default {
		...
		methods: {
			...
			async getPayConfig() {
				...
				// 默认支付方式
				if (this.payWayConf.wechat_pay == 1) {
					this.pay_way = 'wechat_pay';
				} else if (this.canAlipay && this.payWayConf.alipay == 1) {
					this.pay_way = 'alipay';
				} else if (this.payWayConf.balance_pay == 1) {
