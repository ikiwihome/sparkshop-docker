...
trait PostageTrait
{
    /**
     * 通过模板计算出邮费
     * @param array $goodsPostage
     * @param int $addressId
     * @return int
     */
    public function getPostageByTpl(array $goodsPostage, int $addressId)
    {
        try {
     ...
     * @param array $checkedTpl
     * @param array $goods2Tpl
     * @return float|int
     */
    private function calcPostageByType(array $checkedTpl, array $goods2Tpl)
    {
        $optTpl = $checkedTpl;
        ...
        return round($firstTpl['first_price'] + $continuePrice, 2);
    }
     ...
     * @return float|int
     */
    private function calcContinuePrice(array $checkedTpl, array $item, string $type)
    {
        $continuePrice = 0;
